...
export function getApiUrlCandidates(): string[] {
  // On web, always use the page's own origin so API calls are same-origin.
  // This avoids cross-origin cookie issues (sameSite cookies won't be sent
  // if the Expo constants or EXPO_PUBLIC_API_URL resolve to a different host).
