...
import { analyses, appSettings, metrics, coachingInsights, sportMovements, sports, users } from "@swing-ai/shared/schema";
import { and, desc, eq, isNotNull, ne, or } from "drizzle-orm";
import { spawn } from "child_process";
import { createHash } from "crypto";
import { getConfigKey, getSportConfig } from "@swing-ai/shared/sport-configs";
import {
  ...
  type PipelineTiming,
} from "@swing-ai/shared/pipeline-timing";
import { normalizeMetricValueToTenScale } from "@swing-ai/shared/metric-scale";
import {
  isVideoValidationMode,
  type ValidationScreeningSnapshot,
  type VideoValidationMode,
} from "@swing-ai/shared/video-validation";
import { readModelRegistryConfig } from "./model-registry";
import {
  toPersistedScoreTen,
} from "../lib/score-scale";
import { buildScoreInputsPayload } from "../lib/score-inputs";
import { buildScoreOutputsPayload } from "../lib/score-outputs";
import { extractStandardizedTacticalScores10 } from "../lib/tactical-scores";
import fs from "fs";
import path from "path";
import type { AiDiagnosticsPayload, ScoreInputsPayload, ScoreOutputsPayload } from "@swing-ai/shared/schema";
