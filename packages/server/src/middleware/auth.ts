...
import { users, registerSchema, loginSchema, type User } from "@swing-ai/shared/schema";
import {
  DEFAULT_SELECTED_METRIC_KEYS,
  DEFAULT_SELECTED_SCORE_SECTIONS,
} from "@swing-ai/shared/default-user-preferences";
import { eq, or, sql } from "drizzle-orm";
import { resolveMediaUrl, storeAvatarBuffer } from "../services/media-storage";
import { buildInsertAuditFields, buildUpdateAuditFields } from "../lib/audit";
import { listSports, normalizeSportName } from "../services/sport-availability";
