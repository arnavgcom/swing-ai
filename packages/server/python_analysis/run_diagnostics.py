                ...
                shot_segments.append(
                    {
                        ...
                        "classificationDebug": {
                            ...
                            "dominantWristMeanSpeed": round(float(segment_features.get("dominant_wrist_mean_speed", 0.0)), 4),
                            "dominantWristSpeedStd": round(float(segment_features.get("dominant_wrist_speed_std", 0.0)), 4),
                            "dominantWristSpeedP90": round(float(segment_features.get("dominant_wrist_speed_p90", 0.0)), 4),
                            "dominantWristAccelP90": round(float(segment_features.get("dominant_wrist_accel_p90", 0.0)), 4),
                            "peakSpeedFrameRatio": round(float(segment_features.get("peak_speed_frame_ratio", 0.0)), 4),
                            "dominantWristHorizontalRangeRatio": round(float(segment_features.get("dominant_wrist_horizontal_range_ratio", 0.0)), 4),
                            "dominantWristVerticalRangeRatio": round(float(segment_features.get("dominant_wrist_vertical_range_ratio", 0.0)), 4),
                            "wristHeightRange": round(float(segment_features.get("wrist_height_range", 0.0)), 4),
                            "peakWristHeightFrameRatio": round(float(segment_features.get("peak_wrist_height_frame_ratio", 0.0)), 4),
                            "contactHeightStd": round(float(segment_features.get("contact_height_std", 0.0)), 4),
                            "shoulderRotationDeltaDeg": round(float(segment_features.get("shoulder_rotation_delta_deg", 0.0)), 4),
                            "shoulderRotationRangeDeg": round(float(segment_features.get("shoulder_rotation_range_deg", 0.0)), 4),
                            "shoulderRotationStdDeg": round(float(segment_features.get("shoulder_rotation_std_deg", 0.0)), 4),
                            "dominantWristOffsetStd": round(float(segment_features.get("dominant_wrist_offset_std", 0.0)), 4),
